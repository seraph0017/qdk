...
def createdb():
    db.create_all()
    k1 = Keng(gender=0, name=u"喜士多",location=u"十二楼男厕左",status=0,is_available=False,device_id="fujun")
    k2 = Keng(gender=0, name=u"全家",location=u"十二楼男厕中",status=0,is_available=False,device_id="xunan")
    k3 = Keng(gender=1, name=u"711",location=u"十二楼男厕右",status=0,is_available=False,device_id="xukaikai")
